...
function SideBar() {
  const { toggle, mobileNavOpen, handleMobileNavToggle } = useToggle();

  return (
    <StyledSidebar $toggle={toggle} $mobileNavOpen={mobileNavOpen}>
      <CloseButton $toggle={toggle} onClick={handleMobileNavToggle}>
        ×
      </CloseButton>
      <Logo />
      <MainNav />
